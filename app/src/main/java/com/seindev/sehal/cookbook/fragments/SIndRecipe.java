...
import com.seindev.sehal.cookbook.tabs.SlidingTabLayout;

/**
 * Created by sehal on 5/25/2015.
 */
public class SIndRecipe extends Fragment {
    //INITIALIING
    ViewPager mPager;
    ...
    class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 1:
                    fragment = SIngredients.newInstance("", "");
                    break;
                case 0:
                    fragment = SRecipe.getInstance(position);
                    break;
            }
