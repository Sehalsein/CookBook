...
import com.seindev.sehal.cookbook.Settings;
import com.seindev.sehal.cookbook.adapters.NAdapter;
import com.seindev.sehal.cookbook.infos.NavigationInfo;
import com.seindev.sehal.cookbook.misc.Communicator;
import com.seindev.sehal.cookbook.misc.NavClickListener;
 ...
 */
public class NavigationDrawer extends Fragment implements NavClickListener {
...
*/
    ...
    public void itemClicked(Context context, int position) {
        ...
        switch (position) {
            ...
            case 2:
                mDrawerLayout.closeDrawers();
                startActivity(new Intent(getActivity(), Recipeday.class));
                break;
            case 3:
                mDrawerLayout.closeDrawers();
